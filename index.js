    ...
    if (extSettingsContainer && !document.getElementById("st-fragment-hub-settings-entry")) {
      ...
      panel.innerHTML = `
        <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:6px;">
          <h4 style="margin:0;"><i class="fa-solid fa-note-sticky"></i> 灵感碎片 (Fragment Hub)</h4>
          <span style="font-size:12px; opacity:0.7;">快捷键: Alt + F</span>
        </div>
        <p style="font-size:12px; opacity:0.8; margin:0 0 8px 0;">剧情脑洞、对白碎片、伏笔与番外管理系统</p>
        <button id="btn-st-fh-open-from-settings" class="menu_button" style="width:100%;"><i class="fa-solid fa-arrow-up-right-from-square"></i> 打开灵感便签</button>
      `;
